...
def write_recolorable_runtime_script(out_root: str) -> tuple[str, str]:
...
def write_identity_runtime_script(out_root: str) -> tuple[str, str]:
...
def write_editor_material_fixer(out_root: str, pipeline: str,
    ...
    write_recolorable_runtime_script(out_root)
    write_breakable_runtime_script(out_root)
    write_identity_runtime_script(out_root)
